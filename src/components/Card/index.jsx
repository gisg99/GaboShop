  ...
  return (
    <div className="w-56 h-64 overflow-hidden transition-all ease-out duration-200 hover:scale-110 hover:z-20">
        <figure className="relative mb-2 w-full h-4/5 rounded-2xl overflow-hidden">
            ...
            <div onClick={() => setCount(count + 1)} className="absolute top-2 right-2 h-10 w-10 flex justify-center items-center bg-[#2b0c68] border-2 border-black rounded-full transition-all ease-out duration-500 cursor-pointer hover:bg-[#6200ca] hover:rotate-[90deg]">+</div>
        </figure>
